...
int main()
{
	...
	intGraph.addArc(0, 1, 100);
	intGraph.addArc(0, 3, 40);
	intGraph.addArc(1, 2, 40);
	intGraph.addArc(1, 6, 10);
	intGraph.addArc(2, 4, 11);
	intGraph.addArc(3, 7, 402);
	intGraph.addArc(5, 1, 1123);
	intGraph.addArc(6, 2, 3);
	intGraph.addArc(6, 7, 50);
	intGraph.addArc(7, 5, 1112);
	intGraph.addArc(7, 6, 402);
