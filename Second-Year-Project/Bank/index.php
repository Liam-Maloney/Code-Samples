 ...
 <!-- ----------------  DROPDOWN MENU START  --------------------------------- -->
        <ul class="dropmenu">
            ...
            <ul class="menu" id="menu1">
                <li><a href="./tom/lodgements.html.php" target="content" >Lodgements</a>
                </li>
            ...
            <ul class="menu" id="menu2">
                ...
                <ul class="submenu" id="submenu2">
                    <li><a href="./ciara/open_deposit_ac.html.php" target="content">Open</a>
                    </li>
                    <li><a href="./ciara/close_deposit_ac.html.php" target="content">Close</a>
                    </li>
                    <li><a href="./ciara/view_deposit_ac.html.php" target="content">View</a>
                    </li>
                </ul>
                <li><a onmouseenter="showSubMenu('submenu3')">Loan Accounts</a>
                </li>
                <ul class="submenu" id="submenu3">
                    <li><a href="./liam/open_loan_ac.html.php" target="content" > Open</a>
                    </li>
                    <li><a href="./liam/close_loan_ac.html.php" target="content" >Close</a>
                    </li>
                    <li><a href="./liam/amend_loan_ac.html.php" target="content" >Amend/View</a>
                    </li>
                </ul>
            </ul>
            ...
            <ul class="menu" id="menu3">
                <li><a href="./tom/add_customer.html.php" target="content">Add</a>
                </li>
                <li><a href="./tom/delete_customer.html.php" target="content" >Delete</a>
                </li>
                <li><a href="./tom/amend_customer.html.php" target="content" >Amend/View</a>
                </li>
            </ul>
            ...
            <ul class="menu" id="menu5">
                <li><a  href="./liam/current_ac_history.html.php" target="content" >Current Ac History</a>
                </li>
                <li><a href="./ciara/deposit_ac_history.html.php" target="content">Deposit Ac History</a>
                </li>
                <li><a  href="./liam/loan_ac_history.html.php" target="content">Loan Ac History</a>
                </li>
            ...
            <ul class="menu" id="menu6">
                ...
                <ul class="submenu" id="submenu4">
                    ...
                    <li><a href="./ciara/calcint_deposit_ac.html.php" target="content" >Deposit Account</a>
                    </li>
				
                </ul>
                <li><a onmouseenter="showSubMenu('submenu5')">Charge Interest</a ></li>
<ul class="submenu" id="submenu5">
				<li><a href="./peter/chargeint_current_ac.html.php" target="content" >Current Account</a>
                </li>
                <li><a href="./common/unimplemented.html.php" target="content"  >Loan Account</a>
                </li>
        ...
        <li id="password" onmouseover="hideMenu()"><a href="./tom/password.html.php" target="content" target="content" >Password</a>
        </li>
        </ul>
        <!-- ----------------   DROPDOWN MENU END  --------------------------------- -->
</div>
