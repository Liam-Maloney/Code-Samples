...
$_SESSION['helptext'] = "To make a lodgement:<br><br>".
						"Select the customer by name or number<br><br>".
						"Select the appropriate account.<br><br>".
						"Enter the amount and confirm when prompted.<br><br>";
include 'head.php';
?>
